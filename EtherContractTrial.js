...
// const connectWriteContract = new ethers.Contract(contractAddress,contractAbi, signer);
// const tx= await connectWriteContract.Vote("A");
// const txResponse =await tx.wait();
// console.log(txResponse.toString());

}
app.get('/getCandidateA',(req,res)=>{
    res.send(candidateA().toString);
});
